const game = {
    ...
    achievements: [
        ...
        new Achievement("Endgame", "Reach Layer 1.8e308", "Ʊ", () => game.metaLayer.layer.gte(Infinities[0])),
        new Achievement("Superendgame", "Reach Layer 1e1000", "ƱƱƱƱƱƱƱƱƱƱ", () => game.metaLayer.layer.gte(new Decimal("1e1000"))),
    ],
    secretAchievements: [
